    ...
    ui(new Ui::SettingWindow)
{
    ...
    imageSettin1->setStyleSheet("image: url(:/images/settingsBtn.png);"
...
void SettingWindow::dialogStyle(){
    for(int i = 0; i <= 8; i++){
        if(i==iWindow){
            vectorMassive[iWindow]->setStyleSheet("image: url(:/images/icons8dialog.png);"
            ...
            vectorMassive[i]->setStyleSheet("QWidget{"
                                            ...
                                            "QWidget :hover{"
                                            "background-color: rgb(76, 93, 114);"
                                            "image: url(:/images/icons8dialog.png);"
                                            "padding: 10px;}");
        }
    }
    saveSetting();
...
bool SettingWindow::eventFilter(QObject *pObject, QEvent *pEvent){
    if(mIsClickable){
        if(pObject == imageSettin1 && pEvent->type() == QEvent::MouseButtonPress && enabled1 == 1){
            ...
            imageSettin2->setStyleSheet("QWidget{image: url(:/images/icons8setin2.png);}"
                                        "QWidget :hover{"
                                        "image: url(:/images/icons8setin2.png);"
                                        "padding: 3px;}");
            imageSettin1->setStyleSheet("QWidget{image: url(:/images/settingsBtn.png);"
                                        "background-color: rgb(76, 92, 114);}"
                                        "QWidget :hover{"
