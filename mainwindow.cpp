    ...
    ui(new Ui::MainWindow)
{
    ...
    actHide = new QAction();
    actClose->setIcon(QIcon( ":/resources/actions/close.png" ));
    actShow->setIcon(QIcon( ":/resources/actions/show.png" ));
    actShutdown->setIcon(QIcon( ":/resources/actions/shutdown.png" ));
    actReboot->setIcon(QIcon( ":/resources/actions/restart.png" ));
    actSleep->setIcon(QIcon( ":/resources/actions/sleep.png" ));
    actHide->setIcon(QIcon(":/resources/actions/hide.png"));
    ...
    trayIcon = new QSystemTrayIcon( QIcon( ":/resources/other/MyCountDownTimer.svg" ), this );
...
void MainWindow::on_pushButton_clicked()
{
    if (timerIsRun == true){
        ...
        mbutton->setStyleSheet(":hover {"
                               "image: url(:/resources/other/start.png);"
                               "border-style: outset;"
                               "border-width: 2px;"
                               "border-radius: 10px;"
                               "border-color: beige;"
        ...
        mbutton->setStyleSheet(":hover {"
                               "image: url(:/resources/other/stop.png);"
                               "border-style: outset;"
                               "border-width: 2px;"
                               "border-radius: 10px;"
                               "border-color: beige;"
...
void MainWindow::on_about_clicked()
{
    ...
    messageBox->setIconPixmap(QPixmap(":/resources/other/iconMessageBoxQt.png"));
